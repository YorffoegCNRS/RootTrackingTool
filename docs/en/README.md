...
- [Root Tracking Tool: Readme](#root-tracking-tool-readme)
  ...
  - [Dataset](#dataset)
    - [Citation of the dataset](#citation-of-the-dataset)
...
The dataset associated with RTT is publicly available at:
...
- Raw scans of lettuce, corn, and tomatoes grown in Rhizoboxes, acquired at various stages of development;
- The corresponding images preprocessed with Ilastik;
- Raw and preprocessed scans of Arabidopsis thaliana grown in Petri dishes;
- An Excel file containing manual measurements (ImageJ) and measurements generated by the various software programs evaluated in the study, used to compare RTT with other root analysis tools.
...
- 🗄️ [Dataset description](dataset.md)
